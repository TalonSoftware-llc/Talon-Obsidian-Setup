...
objective: Replace the aging router, segment IoT, and add off-site backups for NAS snapshots.
---
...
## Tasks
- [ ] Document current VLANs and firewall rules
- [ ] Order replacement router + APs
- [ ] Draw target topology (trusted / IoT / guest)
- [ ] Test backup restore to cold storage quarterly
