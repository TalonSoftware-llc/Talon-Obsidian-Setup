...
objective: Standardize kickoff → handoff so every new client gets the same great first two weeks.
---
...
## Tasks
- [x] Draft welcome email + calendar holds
- [ ] Create shared drive structure template
- [x] Record Loom for “how we work” rituals
- [x] Define success metrics for day 30 / day 90
- [x] Pilot with one friendly client and iterate
