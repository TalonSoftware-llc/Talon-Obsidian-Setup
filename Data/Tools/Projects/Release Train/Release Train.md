...
objective: Ship a predictable two-week release cadence with quality gates, rollback playbooks, and comms templates.
---
...
## Tasks
- [x] Agree on release calendar and freeze windows
- [x] Add smoke tests to CI for critical paths
- [ ] Publish rollback checklist in runbook
- [ ] Notify customers via template for each train
