...
objective: Give partners self-serve deal registration, MDF visibility, and co-branded assets in one place.
---
...
## Tasks
- [ ] Finalize PRD with partner advisory group
- [ ] Choose auth model (SSO vs invite-only)
- [ ] Wire CRM opportunity ID on registration
- [ ] Design MDF accrual view (read-only v1)
- [ ] Beta with two lighthouse partners
