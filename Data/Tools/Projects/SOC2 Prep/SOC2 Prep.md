...
objective: Complete evidence collection and control testing for SOC 2 Type II with a clean auditor handoff.
---
...
## Tasks
- [x] Inventory systems in scope (IDP, ticketing, prod access)
- [ ] Map controls to owners and evidence locations
- [x] Run access review sampling for Q1
- [x] Draft vendor risk questionnaires for critical subs
- [x] Walkthrough with auditor — dry run
- [ ] add more things to demo
- [x] export controls setup
- [ ] unifi firewall rule audit
