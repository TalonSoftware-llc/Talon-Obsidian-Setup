...
objective: Unify product usage, support tickets, and NPS into a single health score per account for CS and AMs.
---
...
## Tasks
- [x] Define health score formula v0 (usage + tickets + NPS)
- [x] Validate data joins with warehouse team
- [x] Build read-only dashboard in BI tool
- [x] Pilot with 10 CSMs; gather feedback
- [x] Add alerts when score drops a tier
- [x] test
- [x] test
- [x] test
- [x] est
