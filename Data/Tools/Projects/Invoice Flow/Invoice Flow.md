...
objective: Cut days-to-pay with clearer invoicing rules, auto-reminders, and AR aging dashboards.
---
...
## Tasks
- [x] Map current invoice → cash flow in BI
- [ ] Pilot dunning emails on one segment
- [ ] Define escalation rules for 60+ days
- [ ] Train CS on updated billing FAQ
